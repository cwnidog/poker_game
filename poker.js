...
function Hold(num){
  ...
  if (!held[num]){
    held[num] = true;
    document.images[5 + num].src = "card_images/hold2.gif";
  } //! held[num]
  else{
    held[num] = false;
    document.images[5 + num].src = "card_images/hold.gif";
  }
} // Hold()
...
function fname(){
  return "card_images/" + this.num + this.suit + ".gif";
} // fname()
...
function Addscore(){
  ...
  if(pairs == 2){
    document.form1.message.value = "Two Pairs";
    return 2;
  }
  ...
  if(pairs == 1){
    if (tally[1] == 2 || tally[11] == 2 || tally[12] == 2 || tally[13] == 2){
      document.form1.message.value = "Jacks or Beter";
      return 1;
    }
  } // is pairs == 1
